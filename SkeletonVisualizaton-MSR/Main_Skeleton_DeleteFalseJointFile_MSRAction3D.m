function Main_Skeleton_DeleteFalseJointFile_MSRAction3D(AS)
%generate mesh
%Author: Jin Qi
%Date:   3/26/2014
...
%%
TrueJointDir='./data/';
%ImageDatabase='./Database/MSRAction3DSkeletonReal3D/'; Don't use this line
ImageDatabase='./Database/'; % for MSRAcion3D consistent with CAD60
...
for j=1:length(SubjectNameList)
    ...
    indx=ismember(Action,AS);
    FileList=FileList(indx);
    Action=Action(indx);
    Subject=Subject(indx);
