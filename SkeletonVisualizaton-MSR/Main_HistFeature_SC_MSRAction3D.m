function Main_HistFeature_SC_MSRAction3D()
%generate mesh
%Author: Jin Qi
%Date:   1/30/2014
...
% FirstN=300;% for MSRAcion3D  accuracy 87.87
 FirstN=350;% for MSRAcion3D  accuracy 89.54, accuracy 89.70 for "cornell" 97 FOR AS3
% FirstN=400;% for MSRAcion3D  accuracy 88.89
% FirstN=500;% for MSRAcion3D  accuracy 87.5 for AS2
% FirstN=500;% for MSRAcion3D  accuracy   87.6     for AS1
FirstN=500;
Thr=0.02;
